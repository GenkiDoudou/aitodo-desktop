...
export const IPC = {
  ...
  TASKS_COUNT_INBOX: 'tasks:countInbox',
  ...
  APP_GET_ATTACHMENT_PREFS: 'app:getAttachmentPrefs',
  APP_SET_ATTACHMENT_PREFS: 'app:setAttachmentPrefs',
  APP_TEST_AND_SAVE_S3: 'app:testAndSaveS3',
