...
export const IPC = {
  ...
  DESKTOP_ORGANIZE_SCAN: 'desktopOrganize:scan',
  DESKTOP_ORGANIZE_PREVIEW: 'desktopOrganize:preview',
  DESKTOP_ORGANIZE_EXECUTE: 'desktopOrganize:execute',
  DESKTOP_ORGANIZE_UNDO: 'desktopOrganize:undo',
  DESKTOP_ORGANIZE_CAN_UNDO: 'desktopOrganize:canUndo',
  DESKTOP_ORGANIZE_SETTINGS_GET: 'desktopOrganize:settingsGet',
  DESKTOP_ORGANIZE_SETTINGS_SET: 'desktopOrganize:settingsSet',
  DESKTOP_ORGANIZE_CATEGORIES_LIST: 'desktopOrganize:categoriesList',
  DESKTOP_ORGANIZE_CATEGORIES_CREATE: 'desktopOrganize:categoriesCreate',
  DESKTOP_ORGANIZE_CATEGORIES_UPDATE: 'desktopOrganize:categoriesUpdate',
  DESKTOP_ORGANIZE_CATEGORIES_DELETE: 'desktopOrganize:categoriesDelete',
  DESKTOP_ORGANIZE_CATEGORIES_REORDER: 'desktopOrganize:categoriesReorder',
  DESKTOP_ORGANIZE_MANUAL_SET: 'desktopOrganize:manualSet',
  DESKTOP_ORGANIZE_MANUAL_REMOVE: 'desktopOrganize:manualRemove',
  DESKTOP_ORGANIZE_GET_DESKTOP_PATH: 'desktopOrganize:getDesktopPath',
  DESKTOP_ORGANIZE_OPEN_DESKTOP: 'desktopOrganize:openDesktop',
  ...
  FENCE_GET_SETTINGS: 'fence:getSettings',
  FENCE_UPDATE_SETTINGS: 'fence:updateSettings',
  FENCE_SHOW_ALL: 'fence:showAll',
  FENCE_HIDE_ALL: 'fence:hideAll',
  FENCE_LIST_LAYOUTS: 'fence:listLayouts',
  FENCE_UPDATE_LAYOUT: 'fence:updateLayout',
  /** Main → Fence：推送扫描结果 */
  FENCE_SCAN_PUSH: 'fence:scanPush',
  FENCE_HIDE_WINDOW: 'fence:hideWindow',
  FENCE_GET_FILE_ICON: 'fence:getFileIcon',
  FENCE_OPEN_ITEM: 'fence:openItem',
  FENCE_BEGIN_DRAG: 'fence:beginDrag',
  FENCE_DROP_ITEM: 'fence:dropItem',
  FENCE_END_DRAG: 'fence:endDrag',
  FENCE_RECOVER_DESKTOP_ICONS: 'fence:recoverDesktopIcons',
  FENCE_WALLPAPER_GET: 'fence:wallpaperGet',
  FENCE_WALLPAPER_PICK: 'fence:wallpaperPick',
  FENCE_WALLPAPER_APPLY: 'fence:wallpaperApply',
  FENCE_WALLPAPER_RESTORE: 'fence:wallpaperRestore',
  FENCE_WALLPAPER_LIST_PRESETS: 'fence:wallpaperListPresets',
  FENCE_WALLPAPER_APPLY_PRESET: 'fence:wallpaperApplyPreset',
  DESKTOP_ORGANIZE_CUSTOM_RULES_LIST: 'desktopOrganize:customRulesList',
  DESKTOP_ORGANIZE_CUSTOM_RULES_CREATE: 'desktopOrganize:customRulesCreate',
  DESKTOP_ORGANIZE_CUSTOM_RULES_UPDATE: 'desktopOrganize:customRulesUpdate',
  DESKTOP_ORGANIZE_CUSTOM_RULES_DELETE: 'desktopOrganize:customRulesDelete',
  DESKTOP_ORGANIZE_DEFAULT_RULES_LIST: 'desktopOrganize:defaultRulesList',
  DESKTOP_ORGANIZE_DEFAULT_RULES_SET_ENABLED: 'desktopOrganize:defaultRulesSetEnabled'
} as const
