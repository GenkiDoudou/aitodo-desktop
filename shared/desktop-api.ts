...
export interface DesktopApi {
  ...
  sync: {
    login(dto: SyncLoginRequest): Promise<IpcResult<import('@shared/sync-protocol').SyncAuthResult>>
    register(dto: SyncRegisterRequest): Promise<IpcResult<import('@shared/sync-protocol').SyncAuthResult>>
    completeLogin(
      request: import('@shared/sync-protocol').SyncCompleteLoginRequest
    ): Promise<IpcResult<import('@shared/sync-protocol').SyncAuthResult>>
