...
function shouldShowKanbanDoneColumn(scope) {
  return scope !== "all";
}
function taskMatchesHideDoneScope(task, scope, base = dayjs()) {
...
function coerceHideDoneScope(value, fallback = "all") {
