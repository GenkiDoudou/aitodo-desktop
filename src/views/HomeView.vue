...
import { filterTasksBySelectedLists } from '@shared/visible-lists'
...
const visibleListsAll = ref<string[]>(readVisibleListIds('all'))
const visibleListsMatrix = ref<string[]>(readVisibleListIds('matrix'))
...
/** 四象限：与列表一致，仅在命名视图导航时应用 filterRule；侧栏四象限再套清单多选 */
